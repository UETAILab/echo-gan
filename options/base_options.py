...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='cycleganhd', help='chooses which model to use. [multichannel | munit | unit | video_gan | cycle_gan | cycle_gan_condition | pix2pix | test | colorization | medgan]')
