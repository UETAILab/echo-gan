...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        # parser.add_argument('--dataroot', default="C:/Users/admin/PycharmProjects/video_style_transfer/data", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--dataroot', default="../../data/uetgan", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='unit', help='chooses which model to use. [multichannel | munit | unit | video_gan | cycle_gan | cycle_gan_condition | pix2pix | test | colorization | medgan]')
        ...
        parser.add_argument('--netG', type=str, default='casnet', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
